...
final class NettyExecutors {
  ...
  public static final ExecutorService ASYNC_CACHE_MANAGER_EXECUTOR =
      new ForkJoinPool(Configuration.getInt(PropertyKey.WORKER_NETWORK_NETTY_ASYNC_CACHE_MANAGER_THREADS_MAX));

  public static final ExecutorService BLOCK_READER_EXECUTOR =
        new ForkJoinPool(Configuration.getInt(PropertyKey.WORKER_NETWORK_NETTY_BLOCK_READER_THREADS_MAX));
